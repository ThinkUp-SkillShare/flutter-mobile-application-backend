...
namespace SkillShareBackend.Models
{
    ...
    public class GroupCall
    {
        ...
        [NotMapped]
        public int Duration => EndedAt.HasValue ? 
            (int)(EndedAt.Value - StartedAt).TotalSeconds : 0;
    ...
    public class CallParticipant
    {
        ...
        [NotMapped]
        public int Duration => LeftAt.HasValue ? 
            (int)(LeftAt.Value - JoinedAt).TotalSeconds : 0;
