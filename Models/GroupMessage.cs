...
public class GroupMessage
{
    ...
    [MaxLength(20)]
    [Column("message_type")]
    public string MessageType { get; set; } = "text"; // text, image, audio, file

    [Column("content")] public string? Content { get; set; }

    [MaxLength(500)] [Column("file_url")] public string? FileUrl { get; set; }

    [MaxLength(255)] [Column("file_name")] public string? FileName { get; set; }

    [Column("file_size")] public long? FileSize { get; set; }

    [Column("duration")] public int? Duration { get; set; } // For audio in seconds

    [Column("reply_to_message_id")] public int? ReplyToMessageId { get; set; }

    [Column("is_edited")] public bool IsEdited { get; set; } = false;
    ...
    [ForeignKey("ReplyToMessageId")] public virtual GroupMessage? ReplyToMessage { get; set; }
